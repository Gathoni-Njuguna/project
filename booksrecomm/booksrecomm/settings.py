...
ALLOWED_HOSTS = ['project-1-0q4w.onrender.com', 'localhost', '127.0.0.1']
...
ROOT_URLCONF = 'booksrecomm.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': [os.path.join(BASE_DIR, 'books/templates')],  # Add your templates directory here
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'booksrecomm.wsgi.application'
